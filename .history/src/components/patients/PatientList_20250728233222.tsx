...
console.log('typeof TestModal:', typeof TestModal);

// Fix for the import issue
import AddPatientModalModule from './AddPatientModal';
console.log('Full module:', AddPatientModalModule);
console.log('Module keys:', Object.keys(AddPatientModalModule || {}));
console.log('Module.default:', AddPatientModalModule?.default);
console.log('typeof Module.default:', typeof AddPatientModalModule?.default);
const AddPatientModal = AddPatientModalModule.default || AddPatientModalModule;
